...
| Diagnostics | Lint (66 rules), parse errors, compile errors |
...
Runs all 66 lint rules from `rsigma-parser` (Sigma spec v2.1.0). Loads `.rsigma-lint.yml` config from ancestor directories and respects inline `# rsigma-disable` comments.
