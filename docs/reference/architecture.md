...
| `rstix` | STIX 2.1 + TAXII 2.1 library crate under phased implementation. | `parse_bundle` placeholder, core primitives, deterministic SCO-ID helpers, and vocabulary tables | `serde` |
