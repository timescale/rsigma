...
| **Verdict-driven capture** | `rsigma_capture_incidents_open`, `rsigma_capture_events_held`, `rsigma_capture_spool_jobs_total` | Is the evidence ring holding events, and are accepted verdicts spooling? |
